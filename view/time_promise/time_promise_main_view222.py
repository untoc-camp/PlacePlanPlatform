...
class AppointmentApp:
    ...
    def add_new_appointment(self):
        ...
        jp.A(text='일정 수정하기', href='/timepromise/make', classes='bg-blue-100 hover:bg-blue-200 text-blue-800 text-sm py-1 px-3 rounded-full', a=appointment_div, style="margin-top: 10px;")
